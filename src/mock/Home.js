...
export const ServicesData = [
  {
    ...
    list1: [
      "Picture of an architecture diagram of the Elastic Stack or some other vendor agnostic endpoint protection related image.",
...
export const PlansData = [
  ...
  },
  {
    ...
    details: [
      ...
      {
        desc: "Starting at 9.99 USD / month",
      },
      {
        desc: "Email, DNS, website builder",
      },
      {
        desc: "MySQL and PSQL Databases",
      },
      {
        desc: "cPanel Webdisk",
      },
